...
const PATRONES_RUIDO = [
  ...
  // Páginas de agregador que se cuelan como si fueran notas:
  // "AAPL 260828 320.00C (AAPL260828C320000) Stock Options Chain | Quotes & News"
  /\b(options? chain|quotes? (&|and) news|stock quote|historical data|price history)\b/i,
  /\b[A-Z]{1,6}\d{6}[CP]\d{6,}\b/, // contrato de opción en el titular
];
